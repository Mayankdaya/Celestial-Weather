...
export function WeatherPage() {
  ...
  const GlassmorphismCard = ({ children, className }: { children: React.ReactNode, className?: string }) => (
    <Card className={cn('bg-white/30 border-white/20 backdrop-blur-xl shadow-lg rounded-2xl transition-all duration-300 hover:shadow-2xl hover:border-white/30', className)}>
      {children}
    </Card>
  );
  ...
  return (
    <SidebarProvider>
      ...
      >
        <Sidebar collapsible='icon' className='border-r border-black/10 bg-black/5 backdrop-blur-xl'>
          <SidebarContent>
            <SidebarMenu>
          ...
          <header className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
              ...
              <div className="relative flex w-full sm:max-w-xs">
                <Input
                  ...
                  className="pr-20 h-11 text-base bg-black/10 border-black/20 placeholder:text-gray-600 text-foreground rounded-full focus:ring-primary focus:border-primary"
                />
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-full">
                      ...
                      <Progress value={weather.pollen.grass.value} className="h-2 bg-black/10 [&>div]:bg-green-500" />
                    </div>
                  </div>
                   <div className="flex items-center gap-4">
                    ...
                    <div className="w-full">
                      ...
                      <Progress value={weather.pollen.weed.value} className="h-2 bg-black/10 [&>div]:bg-purple-500" />
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-full">
                      ...
                      <Progress value={weather.pollen.tree.value} className="h-2 bg-black/10 [&>div]:bg-amber-600" />
                    </div>
                  </div>
                </CardContent>
              </GlassmorphismCard>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="w-full">
                      ...
                      <Progress value={weather.airPollutants.ozone.value} className={cn("h-2 bg-black/10", getProgressColor(weather.airPollutants.ozone.level))} />
                    </div>
                  </div>
                   <div className="flex items-center gap-4">
                    <div className="w-full">
                      ...
                      <Progress value={weather.airPollutants.carbonMonoxide.value} className={cn("h-2 bg-black/10", getProgressColor(weather.airPollutants.carbonMonoxide.level))} />
                    </div>
                  </div>
                   <div className="flex items-center gap-4">
                    <div className="w-full">
                      ...
                      <Progress value={weather.airPollutants.sulfurDioxide.value} className={cn("h-2 bg-black/10", getProgressColor(weather.airPollutants.sulfurDioxide.level))} />
                    </div>
                  </div>
                </CardContent>
              </GlassmorphismCard>
              ...
              <GlassmorphismCard className="md:col-span-2 xl:col-span-4 text-foreground">
                ...
                <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {weather.activitySuggestions.map((activity, index) => (
                        <div key={index} className="flex items-start gap-3 p-3 bg-black/5 rounded-lg">
                ...
                <CardContent className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                  <div className="grid grid-cols-4 sm:grid-cols-7 xl:col-span-1 gap-2 text-center">
                    {weather.forecast.map((day, index) => (
                      <div key={index} className="flex flex-col items-center p-2 bg-black/5 rounded-lg">
